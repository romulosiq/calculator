class CalcController {
	...
	/**
	 * Função execCommand() está depreciada.	 *
	 * 
	copyToClipboard() {
	...
	*/
	...
	/**
	 * Método refatorado que substitui o anterior
	 */
	copyToClipboard() {
	...
	set displayCalc(value) {
		if (value.toString().length > this._limitDigitsOnDisplay) {
			this.setError();
			return false;
		}
